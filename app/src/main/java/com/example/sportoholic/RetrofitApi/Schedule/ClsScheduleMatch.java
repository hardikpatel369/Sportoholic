...
public class ClsScheduleMatch {
    ...
    @Expose
    private ClsScheduleVenue clsScheduleVenue;
    ...
    public ClsScheduleVenue getClsScheduleVenue() {
        return clsScheduleVenue;
    }

    public void setClsScheduleVenue(ClsScheduleVenue clsScheduleVenue) {
        this.clsScheduleVenue = clsScheduleVenue;
    }
